      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="border border-red-300 rounded-[0.8rem] p-3 flex justify-between items-center bg-[#fffaf9]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-[12px] font-medium leading-tight">Neurologist<br />Bir Hospital</p>
            </div>
          </div>
          <div className="text-right flex flex-col items-end gap-1">
            <p className="text-[#d32f2f] text-[13px] font-bold">March 24</p>
            <p className="text-gray-600 text-[12px] font-semibold">9:00 AM</p>
            <span className="bg-[#ffcccc] text-[#d32f2f] text-[10px] font-extrabold px-3 py-0.5 rounded-full">Reschedule</span>
          </div>
        </div>
        ...
        <div className="border border-[#70b3a3] rounded-[0.8rem] p-3 flex justify-between items-center bg-[#f7fcfb]">
          ...
          <div className="text-right flex flex-col items-end gap-1">
            ...
            <p className="text-gray-600 text-[12px] font-semibold">9:00 AM</p>
            <span className="bg-[#ddeadb] text-[#1b6a55] text-[10px] font-extrabold px-3 py-0.5 rounded-full">Confirmed</span>
          </div>
        </div>
