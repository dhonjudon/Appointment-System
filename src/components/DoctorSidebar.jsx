  ...
  return (
    <div className="w-[240px] bg-[#1a6654] flex flex-col hidden md:flex shrink-0 shadow-xl z-20">
      ...
      <nav className="flex flex-col gap-2 px-4 flex-1 mt-4">
        ...
        <Link to="/doctor-reports" className={`flex items-center gap-4 px-4 py-3.5 rounded-xl transition ${currentPath === '/doctor-reports' ? 'bg-white/20 text-white font-bold shadow-sm' : 'text-white/70 hover:text-white hover:bg-white/10 font-semibold'}`}>
