...
function DoctorProfileSetup() {
  ...
  const [profileImage, setProfileImage] = useState("https://ui-avatars.com/api/?name=Dr+Sharma&background=1b6a55&color=fff&size=160");
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
                ...
                <div className="lg:col-span-3 flex flex-col items-center">
                  ...
                  />
                  <button onClick={handleUploadClick} className="flex items-center gap-2 px-6 py-2.5 rounded-xl border-2 border-[#1b6a55] text-[#1b6a55] font-extrabold text-sm hover:bg-[#1b6a55] hover:text-white transition w-full justify-center mb-3">
