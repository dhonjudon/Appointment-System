      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="w-11 h-11 rounded-full bg-[#1b6a55] flex items-center justify-center text-white font-bold shadow-sm">
              SA
            </div>
          </div>
          ...
          <div className="bg-[#1a3d36] rounded-xl mb-6 p-8 relative overflow-hidden flex items-center">
            ...
            <div className="relative z-10 flex items-center gap-6">
              <div className="relative">
                <div className="w-24 h-24 rounded-full bg-[#1b6a55] flex items-center justify-center text-white text-3xl font-bold border-4 border-[#1a3d36]">
                  SA
                </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5 border-t border-gray-100 pt-5">
                <div>
