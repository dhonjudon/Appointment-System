...
// Collects email, password, name, phone, and DOB before redirecting to onboarding
...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!agreeToTerms) {
      setError("You need to agree to the terms before registering.");
      return;
    }
    ...
    try {
      ...
      // Store signup draft and token, then navigate to onboarding
        ...
        <div className="w-full max-w-sm xl:max-w-md bg-transparent mt-8 md:mt-0">
          ...
          <form className="w-full" onSubmit={handleSubmit}>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center w-full bg-[#f4f7f8] border-[1.5px] border-[#aab2b8] focus-within:border-gray-600 rounded-[5px] transition-colors py-[7px] px-3">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent outline-none text-gray-800 placeholder-gray-500 font-medium text-[13px]"
                  />
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 mb-6 bg-[#2f705c] text-white font-bold rounded-full flex justify-center items-center hover:bg-[#1f5647] transition-colors shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
            >
