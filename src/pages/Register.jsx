            ...
            <div className="flex gap-4 mb-4">
              ...
              <div className="flex-1 relative">
                ...
                >
                  ...
                  <input type="text" readOnly value={formattedDob} placeholder="DD/MM/YYYY" className="w-full bg-transparent outline-none text-gray-800 placeholder-gray-500 font-medium text-[13px] cursor-pointer" />
                </div>
